...
function generateGridCard(name,desc,price,imgPath){
    let div = document.createElement('div');
    div.classList.add('bg-white shadow-sm hover:shadow-md rounded-lg p-4 w-[95%] max-w-3xl flex items-center');
    div.innerHTML=`
                    <div class="w-1/4 flex justify-center">
                <img src="${imgPath}" alt="${name}" class="w-40 h-40 object-contain">
              </div>
              <div class="w-3/4">
