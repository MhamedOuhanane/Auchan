        ...
        <div class="promotion-card w-[200px]" id="${product.id}">
          <div class="relative img">
            ...
            <div class="absolute top-[20px] left-[20px] content">
              <p class="w-[60px] h-[25px] flex text-sm items-center justify-center bg-white shadow-xl">
                ${product.category}
              </p>
              <p class="w-[60px] h-[25px] flex text-sm items-center justify-center bg-white mt-2 shadow-xl">
                -${product.discount}
              </p>
            </div>
          </div>
        ...
        <div class="flex card-list w-[73%] m-auto card-shadow my-4" id="${product.id}">
              ...
              <div class="flex flex-col ml-10 justify-evenly">
                <div class="flex gap-10">
                  <span
                    class="w-[40px] md:w-[50px] h-[20px] md:h-[25px] flex text-xs md:text-sm lg:text-lg items-center justify-center bg-white shadow-xl">${product.category}</span>
                  <span
                    class="w-[40px] md:w-[50px] h-[20px] md:h-[25px] flex text-xs md:text-sm lg:text-lg items-center justify-center bg-white shadow-xl">-${product.discount}</span>
                </div>
